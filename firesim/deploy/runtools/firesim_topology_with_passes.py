...
class FireSimTopologyWithPasses:
    ...
    def __init__(self, user_topology_name, no_net_num_nodes, run_farm, hwdb,
                 ...
                 defaultfesvrstepsize, defaultfuzzoutput):
        self.passes_used = []
        ...
        self.defaultfesvrstepsize = defaultfesvrstepsize
        self.defaultfuzzoutput = defaultfuzzoutput
    ...
    def pass_apply_default_network_params(self):
        ...
        for node in allnodes:
            ...
            if isinstance(node, FireSimServerNode):
                ...
                if node.fesvr_step_size is None:
                    node.fesvr_step_size = self.defaultfesvrstepsize
                if node.fuzz_output is None:
                    node.fuzz_output = self.defaultfuzzoutput
