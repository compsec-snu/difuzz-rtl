...
class DifuzzRTLRocketConfig extends Config(
  new WithDifuzzRTLFireSimBridges ++
  new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.DifuzzRTLRocketConfig)

class RFuzzRocketConfig extends Config(
...
//*****************************************************************
class DifuzzRTLBoomConfig extends Config(
  new WithDifuzzRTLFireSimBridges ++
  new WithDefaultMemModel ++
  new WithFireSimConfigTweaks ++
  new chipyard.DifuzzRTLBoomConfig)
